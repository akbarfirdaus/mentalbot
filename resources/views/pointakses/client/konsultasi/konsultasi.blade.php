...
<div class="head-title">
	<div class="left">
		<h1>Konsultasi</h1>
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/client/halaman_konsultasi/style.css') }}">
		<ul class="breadcrumb">
			<li>
...
<body>
    ...
    <script src="{{ asset('assets/client/halaman_konsultasi/script.js') }}"></script>
</body>
